...
import 'schema/garage_record.dart';
import 'schema/service_record.dart';
import 'schema/booking_details_record.dart';
...
export 'schema/garage_record.dart';
export 'schema/service_record.dart';
export 'schema/booking_details_record.dart';
...
/// Functions to query GarageRecords (as a Stream and as a Future).
Future<int> queryGarageRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      GarageRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<GarageRecord>> queryGarageRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      GarageRecord.collection,
      GarageRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<GarageRecord>> queryGarageRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query BookingDetailsRecords (as a Stream and as a Future).
Future<int> queryBookingDetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BookingDetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BookingDetailsRecord>> queryBookingDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BookingDetailsRecord.collection,
      BookingDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BookingDetailsRecord>> queryBookingDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query InsuranceRecords (as a Stream and as a Future).
Future<int> queryInsuranceRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<InsuranceRecord>> queryInsuranceRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<InsuranceRecord>> queryInsuranceRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
