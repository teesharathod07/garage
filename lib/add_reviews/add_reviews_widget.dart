...
import 'add_reviews_model.dart';
export 'add_reviews_model.dart';

class AddReviewsWidget extends StatefulWidget {
  const AddReviewsWidget({super.key});

  static String routeName = 'AddReviews';
  static String routePath = '/addReviews';
...
class _AddReviewsWidgetState extends State<AddReviewsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddReviewsModel());
