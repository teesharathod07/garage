...
class UserdashWidget extends StatefulWidget {
  ...
  static String routeName = 'userdash';
  static String routePath = '/userdash';
                      ...
                      GridView(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(NearbygaragesWidget.routeName);
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                boxShadow: [
                          ...
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed(InsuranceWidget.routeName);
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                boxShadow: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Great service! My car was fixed quickly and the staff was very professional.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                                                        .override(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Reasonable prices and excellent customer service. Would recommend!',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                                                        .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 8.0, 0.0, 0.0),
                                            child: Text(
                                              'You can book a service through our app by selecting \'Book Appointment\' and following the steps.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                                                      .override(
