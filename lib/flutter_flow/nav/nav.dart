...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: Greet1Widget.routeName,
          path: Greet1Widget.routePath,
          builder: (context, params) => Greet1Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: UserdashWidget.routeName,
          path: UserdashWidget.routePath,
          builder: (context, params) => UserdashWidget(),
        ),
        FFRoute(
          name: NearbygaragesWidget.routeName,
          path: NearbygaragesWidget.routePath,
